      ...
      {coverageData.benefits && coverageData.benefits.length > 0 && (
        <section className="py-16 bg-off-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-mid-gray text-[10px] font-bold tracking-[0.2em] uppercase mb-3">{t("eyebrows.coverage")}</p>
            <h2 className="font-[family-name:var(--font-heading)] font-black tracking-tight text-2xl text-navy mb-10">
              Key Benefits
            </h2>
