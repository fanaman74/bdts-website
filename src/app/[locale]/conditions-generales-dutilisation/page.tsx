...
export default async function ConditionsGeneralesDutilisationPage() {
  ...
  return (
    <>
      <PageHero title={t("terms_title")} subtitle={t("terms_subtitle")} bg="navy" breadcrumb="BDTS" image="https://images.pexels.com/photos/5668770/pexels-photo-5668770.jpeg?auto=compress&cs=tinysrgb&w=1400" />
